...
class Sidebar extends React.Component {  
  ...
  render() {
    ...
    <Card hoverable={true} className="card" cover={<img src="http://pg9vj30g0.bkt.clouddn.com/header.jpeg" />}>
      <div className="authorImg">
        <Link to="/admin" ><img src='http://pg9vj30g0.bkt.clouddn.com/luffy.jpg' alt="" /></Link>
      </div>
      <Meta
        title={
          <div>
